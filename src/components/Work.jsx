        ...
        <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000" className='max-w-[1000px] m-auto p-[25px] sm:p-[50px] md:p-[10%] lg:p-[50px] xl:px-[0px]  py-[10%] lg:py-[10%]'>
          ...
          <div className='py-8 sm:grid sm:grid-cols-[1fr_5fr] gap-2'>
            ...
            <div>
              ...
              <p className='py-2 text-sm'>August 2022 - Present..</p>
              <li className=' py-2 px-4 text-sm'>Developed and maintained Existing and New code for in-house websites primarily using HTML, CSS, JavaScript, React Js and Tailwind CSS</li>
