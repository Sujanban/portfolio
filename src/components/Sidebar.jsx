...
export const Sidebar = () => {
    return (
        <div className='fixed top-[20%] right-0 p-2 bg-neon rounded-xl'>
            ...
            <div className='hidden md:flex fixed bottom-0 right-5 xl:right-10 w-10 items-center justify-center text-colorsecondary'>
                <ul className=''>
                    <li className='relative rotate-90 mb-28'><a className='text-lg hover:text-neon mb-40 transtition duration-200 ease-in relative left-0 hover:-left-[5px] m-4' href="mailto:bansujan@gmail.com">bansujan@gmail.com</a></li>
                    <li className='mt-4 w-1 h-20 bg-colorsecondary m-auto'></li>
                </ul>
            </div>
        </div>
