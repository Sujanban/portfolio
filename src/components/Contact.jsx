  ...
  return (
    <div className='bg-bgmain text-colorsecondary '>
        <div data-aos="fade-up" data-aos-offset="300" data-aos-duration="1000"  className=' max-w-[1000px] m-auto text-center p-[25px] sm:p-[50px] md:p-[10%] lg:p-[50px] xl:px-[0px]  py-[10%] lg:py-[10%]'>
            ...
            <a className= 'text-sm md:text-base transtition duration-200 ease-in text-neon hover:bg-green-hover border-neon rounded border px-4 py-3' href="">Say Hello</a>
        </div>
    </div>
  )
}
